...
export default async function BenvenutoWifiPage({
  ...
  return (
    <SectionWrapper bg="white">
      ...
      <h1 className="mt-4 font-heading text-2xl text-primary">{t("wifiTitle")}</h1>

      {wb?.wifiNome ? (
        <div className="mt-6 inline-flex flex-col gap-2 rounded-lg border border-border bg-surface px-6 py-5 text-sm">
          <p>
